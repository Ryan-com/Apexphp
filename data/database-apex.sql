...
INSERT INTO `leggende` (`nome_leggenda`, `descrizione_txt`, `foto_leggenda`, `professione`, `copertina`, `link_video`) VALUES
	('Ash', 'Nata nelle spietate terre della Frontiera, la dott.ssa Ashleigh Reid imparò molto presto che l\'unica persona di cui avrebbe mai potuto fidarsi era se stessa. Un giorno fu ingaggiata da un gruppo di mercenari per un\'operazione molto delicata: rubare un tipo di carburante sperimentale oggetto di studio nella città di Olympus, nelle Terre Straniere. Era il lavoro perfetto per lei, così si infiltrò tra i ricercatori manipolandoli psicologicamente per anni. Quando il laboratorio andò distrutto, anche lei morì.', 'Ash-c.jpg', 'Istigatrice tagliente', 'Ash-w.jpg', 'https://www.youtube.com/watch?time_continue=2&v=1R'),
	('Ballistic', 'August era l\'unico erede del patrimonio dei Brinkman, costruito su una fitta rete di affari illeciti. Ma quando i suoi genitori finirono nei guai, il giovane si ritrovò da solo ad amministrare la loro fortuna. Ricco, furioso e ormai sulla via dell\'autodistruzione, August si unì ai Thunderdome Games, i precursori degli odierni Apex Games. Fu così che, con lo pseudonimo di Ballistic, ascese rapidamente al successo. Il suo stile spietato, spericolato ed egoista lo rese la prima vera celebrità dei Thunderdome.', 'Ballistic-c.jpg', 'Tiratore raffinato', 'Ballistic-w.jpg', 'https://www.youtube.com/watch?v=piOCG6ETQzI&source'),
	('Bangalore', 'Proveniente da una famiglia di militari in cui lei, i genitori e i quattro fratelli maggiori servivano l\'IMC, Bangalore è sempre stata eccezionale nell\'arte della guerra. Grande sostenitrice dell\'IMC, era un\'allieva brillante all\'Accademia Militare, nonché l\'unica cadetta in grado di smontare un Peacekeeper, equipaggiarlo con un hop-up strozzatura di precisione e riassemblarlo in meno di 20 secondi, a occhi chiusi.', 'Bangalore-c.jpg', 'Soldato professionista', 'Ballistic-w.jpg', 'https://www.youtube.com/watch?v=JyJhFYNob30'),
	('Bloodhound', 'Bloodhound è unə abile cacciatorə, conosciutə in ogni angolo delle Terre Straniere e della Frrontiera per le sue capacità. Figliə di due ingegneri dello stabilimento New Dawn su Talos, venne cresciutə dallo zio Artur dopo la morte dei suoi genitori, rimasti uccisi in un\'esplosione che rase al suolo la struttura in cui lavoravano. Artur insegnò a Bloodhound la saggezza degli antichi, che dà grande importanza al valore della natura e si oppone all\'avanzare della tecnologia. Ma la tecnologia ha sempre affascinato Bloodhound, che ha persino trovato il modo di fondere vecchio e nuovo per uccidere il Goliath che tormentava la gente del suo villaggio. Quel momento ha cambiato la sua vita per sempre.', 'Bloodhound-c.jpg', 'Cacciatorə tecnologicə', 'Bloodhound-w.jpg', 'https://www.youtube.com/watch?v=euWTbVdRGv0&source');
